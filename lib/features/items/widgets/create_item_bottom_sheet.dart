...
class _CreateItemBottomSheetState extends ConsumerState<CreateItemBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<ItemCreationState>(itemCreationProvider, (previous, next) {
      if (next.createdItem != null) {
        ...
        SnackbarUtils.showSuccess(context, '¡Objeto publicado exitosamente!');
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Condition selector
                    _buildConditionSelector(creationState),
                    
                    SizedBox(height: 24.h),
                    
                    // Exchange type selector
                    _buildExchangeTypeSelector(creationState),
  ...
  Widget _buildConditionSelector(ItemCreationState creationState) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        SizedBox(
          ...
          child: SegmentedButton<ItemCondition>(
            ...
            selected: _selectedCondition != null ? {_selectedCondition!} : {},
  ...
  Widget _buildExchangeTypeSelector(ItemCreationState creationState) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        SizedBox(
          ...
          child: SegmentedButton<ExchangeType>(
            ...
            selected: _selectedExchangeType != null ? {_selectedExchangeType!} : {},
            onSelectionChanged: creationState.isLoading
                ? null
  ...
  Widget _buildActionButtons(ItemCreationState creationState) {
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        label: Text(
          creationState.isLoading ? 'Publicando...' : 'Publicar objeto',
          style: TextStyle(
            fontSize: 16.sp,
            fontWeight: FontWeight.w600,
          ),
  ...
  Future<void> _handleSubmit() async {
    ...
    // Validate condition and exchange type are selected
      ...
      if (mounted) {
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text('Selecciona el estado del objeto'),
            actions: [
              TextButton(
                onPressed: () => Navigator.of(context).pop(),
                child: const Text('OK'),
    ...
    if (_selectedExchangeType == null) {
      if (mounted) {
        showDialog(
          context: context,
          builder: (context) => AlertDialog(
            title: const Text('Selección requerida'),
            content: const Text('Selecciona qué quieres hacer con el objeto'),
            actions: [
              TextButton(
                onPressed: () => Navigator.of(context).pop(),
                child: const Text('OK'),
